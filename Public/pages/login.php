            ...
            <div class="max-w-md mx-auto">
                ...
                <form method="post" action="../../app/controllers/login.php" class="divide-y divide-gray-200">
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="login-password" name="login-password" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Password" />
        ...
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div class="max-w-md mx-auto">
                ...
                <form class="divide-y divide-gray-200">
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        <div class="relative">
                            <input autocomplete="off" id="picture" name="picture" type="file" accept="image/*" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600"/>
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="signup-email" name="signup-email" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Email address" />
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="signup-password" name="signup-password" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Password" />
                        ...
                        <div class="relative">
                            <button class="bg-yellow-500 text-white rounded-md px-2 py-1">Signup</button>
                        </div>
                        <div class="mt-4">
