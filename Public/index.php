                              ...
                              <div class="w-full lg:w-6/12 px-4">
                                  <div class="relative w-full mb-3">
                                      ...
                                      <select required name="assignment[]" id="options-assignment-form" class="hidden absolute z-10 w-48 py-2 mt-2 bg-white rounded-lg shadow-xl" multiple>
                                          <?php foreach ($usersData as $user) { ?>
                                              <option value="<?php echo $user['user_id'] ?>" class="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white selected-option"><?php echo $user['username'] ?></option>
                                          <?php } ?>
                                      </select>
